      ...
      for (let name in global.plugins) {
        ...
        if ((usedPrefix = (match[0] || '')[0])) {
          ...
          try {
            ...
            if (m.limit) m.reply(+ m.limit + ' Limit Telah Dikurangi darimu.') // Jadikan sebagai komentar jika kamu risih dengan pesan ini
          }
          break
        }
      }
...
`.trim(), wm, 'Matikan Antidelete', '.off delete', m.message, {
      contextInfo: {
